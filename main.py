    ...
    for h in range(min_lower, max_upper):
        for j in uni:
            ...
            if 0 <= a < dict_[j]['BBX'][1]:
                ...
                symbol_binary = '0' * max(0,(len(dict_[j]['BITMAP'][a])*4 - len(symbol_binary))) + symbol_binary
                if(dict_[j]['BBX'][2] < 0):
                    symbol_binary = '0' *abs(dict_[j]['BBX'][2]) + symbol_binary
                    symbol_binary = symbol_binary[:dict_[j]['BBX'][0]]
                else:
                    symbol_binary += '0' * dict_[j]['BBX'][2]
                    symbol_binary = symbol_binary[dict_[j]['BBX'][2]:dict_[j]['BBX'][0] + dict_[j]['BBX'][2]]
